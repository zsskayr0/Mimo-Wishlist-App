...
class _MimoDetailScreenState extends State<MimoDetailScreen> {
  ...
  Future<void> _openStore() async {
    ...
    if (!launched && mounted) {
      messenger.showSnackBar(
        const SnackBar(content: Text('Não deu pra abrir o link.')),
      );
    }
  }
  ...
  Future<void> _duplicate() async {
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(const SnackBar(content: Text('Mimo duplicado.')));
  }
  ...
  Future<void> _confirmDelete() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          '"${_mimo.title}" será removido. Essa ação não pode ser desfeita.',
        ),
        actions: [
          TextButton(
        ...
        children: [
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              ...
              const PopupMenuItem(
                value: 'duplicate',
                child: Text('Duplicar em outra pasta'),
              ),
              const PopupMenuItem(
                value: 'delete',
                child: Text(
  ...
  Widget _pastaTagsPills(MimoColors colors) {
    return Wrap(
      ...
      children: [
        _Pill(
          label: _mimo.isUnorganized
              ? 'Desorganizado'
              : 'Pasta: ${_mimo.folderName ?? '—'}',
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: value == option.$1 ? colors.ink : colors.border,
                  ),
                  borderRadius: BorderRadius.circular(10),
                ),
                child: Text(
